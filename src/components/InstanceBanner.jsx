...
import { onInstanceChange, instanceDisplay } from '../lib/invidious.js';
  ...
  return (
    <div className="px-4 py-2 bg-amber-500/10 border-b border-amber-500/30 text-sm flex items-center justify-between gap-4">
      <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400">
        ...
        <span>
          {instanceDisplay(changed.oldUrl)} was unreachable. Auto-switched to {instanceDisplay(changed.newUrl)}.
        </span>
      </div>
      <button
